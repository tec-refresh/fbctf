...
class IndexController extends Controller {
  ...
  public function renderCountdownContent(): string {
    ...
    if ($game === '1') {
      ...
      $next_game_text = date(tr('date and time format'), (int)$next_game);
  ...
  public function renderLogosSelection(): string {
    ...
    return '<ul class="slides" style="display:flex;flex-wrap:wrap;list-style:none;padding:0;margin:0;gap:8px;">' . $logo_items . '</ul>';
  }
